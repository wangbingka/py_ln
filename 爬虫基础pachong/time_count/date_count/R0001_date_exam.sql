 select '检查日期分布',exam_type,visit_type,year(table_time) as year_time ,month(table_time) as month_time,count(*) from 
...
group by exam_type,visit_type,year(table_time) ,month(table_time)
order by exam_type,visit_type,year_time ,month_time
limit 20000;